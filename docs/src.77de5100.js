...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"lib/floorplan/hass.ts":[function(require,module,exports) {
"use strict";
...
(function (Hass) {
  ...
  Hass.HassObject = HassObject;

  class HassEntityStates {}

  Hass.HassEntityStates = HassEntityStates;

  class HassEntityState {}

  Hass.HassEntityState = HassEntityState;
})(Hass || (exports.Hass = Hass = {}));
},{}],"lib/simulator.ts":[function(require,module,exports) {
"use strict";
...
var _hass = require("./floorplan/hass");

var Simulator;
exports.Simulator = Simulator;

(function (Simulator_1) {
  ...
  Simulator_1.SimulatorConfig = SimulatorConfig;
  ...
  Simulator_1.Simulation = Simulation;

  class SimulationEntity {}

  Simulator_1.SimulationEntity = SimulationEntity;
  ...
  Simulator_1.SimulationState = SimulationState;

  class Simulator {
    constructor(simulatorConfig, hassChanged) {
      this.hassChanged = hassChanged;
      this.simulationProcessors = new Array();
      this.hass = new _hass.Hass.HassObject();
    ...
    entityStatesChanged(entityStates) {
  ...
  class SimulationProcessor {
    constructor(simulation, entityStatesChanged) {
      this.simulation = simulation;
      this.entityStatesChanged = entityStatesChanged;
      this.currentIndex = 0;
  ...
  Simulator_1.SimulationProcessor = SimulationProcessor;
})(Simulator || (exports.Simulator = Simulator = {}));
},{"./floorplan/hass":"lib/floorplan/hass.ts"}],"../node_modules/js-yaml/lib/js-yaml/common.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/js-yaml.js":"../node_modules/js-yaml/lib/js-yaml.js"}],"lib/utils.ts":[function(require,module,exports) {
"use strict";
...
(function (Utils) {
  ...
  Utils.parseYaml = parseYaml;

  function fetchTextResource(resourceUrl, useCache = true) {
  ...
  Utils.fetchTextResource = fetchTextResource;

  function fetchImageResource(resourceUrl, useCache) {
    return __awaiter(this, void 0, void 0, function* () {
      resourceUrl = useCache ? resourceUrl : cacheBuster(resourceUrl);
      const request = new Request(resourceUrl, {
        cache: useCache ? 'reload' : 'no-cache',
  ...
  Utils.fetchImageResource = fetchImageResource;
  /***************************************************************************************************************************/
...
},{"js-yaml":"../node_modules/js-yaml/index.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
exports.FloorplanProject = exports.FloorplanProjectDemo = void 0;
...
window.onload = function () {
  ...
  console.log("./local/floorplan/examples");
  ...
  projects.forEach(project => {
    ...
    const floorplanElement = isCard ? document.createElement("floorplan-card") : document.createElement("floorplan-panel");
    floorplanContainer.appendChild(floorplanElement);
    const projectDemo = new FloorplanProjectDemo(floorplanElement, project);
  });
};

class FloorplanProjectDemo {
  constructor(floorplan, project) {
  ...
  init() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let configYamlText = yield _utils.Utils.fetchTextResource(configUrl);
      configYamlText = configYamlText.replace(/local\/floorplan/g, "pkozul/local/floorplan");

      const config = _utils.Utils.parseYaml(configYamlText);

      this.floorplan.setConfig(config);

      if (this.project.statesFile) {
        const simulatorUrl = `${"./local/floorplan/examples"}/${this.project.dir}/${this.project.statesFile}`;
        console.log("Simulator YAML:", simulatorUrl);
        let simulatorYamlText = yield _utils.Utils.fetchTextResource(simulatorUrl);
        ...
        this.simulator = new _simulator.Simulator.Simulator(simulatorConfig, this.floorplan.setHass.bind(this.floorplan));
      }
    });
  }
...
exports.FloorplanProjectDemo = FloorplanProjectDemo;

class FloorplanProject {}

exports.FloorplanProject = FloorplanProject;
},{"./lib/simulator":"lib/simulator.ts","./lib/utils":"lib/utils.ts","process":"../node_modules/process/browser.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
